...
export const visaPagesEn: Record<string, VisaPage> = {
  ...
  "family-stay": {
    ...
    lead: "Support for spouses and children of foreign nationals living in Japan.",
    description:
      "We organize family relationship documents, supporter income, housing, and residence status for dependent visa applications.",
    metaTitle: "Dependent Visa Application Support | Gyoseishoshi Arch Office",
    metaDescription:
      "Support for dependent visa applications in Japan for spouses and children. Requirements, documents, refusal risks, and fees.",
    keywords: ["dependent visa Japan", "family stay visa Japan", "bring family to Japan", "visa application Japan"],
    overview: [
      "A Dependent Visa is for spouses and children supported by a foreign national living in Japan.",
      "Immigration reviews the sponsor's status, income, housing, and the family relationship.",
      "We support Certificate of Eligibility, status change, and renewal applications.",
    ],
    requirements: [
      "The sponsor must hold an eligible residence status in Japan",
      "The applicant must be a legal spouse or child",
      "The sponsor must have sufficient income and living arrangements",
      "Official documents must prove the family relationship",
    ],
    documents: [
      "Application form, photo, passport, and residence card",
      "Marriage certificate, birth certificate, and family relationship documents",
      "Sponsor's residence card, residence certificate, employment or school certificate",
      "Tax certificates, salary slips, bank records, and housing documents",
    ],
    refusalReasons: [
      "Sponsor's income is insufficient or unstable",
      "Family relationship documents are incomplete or inconsistent",
      "Living arrangement or support plan is unclear",
      "Sponsor has problems with status, tax, or social insurance compliance",
    ],
    support: [
      "Review of sponsor and family situation",
      "Document checklist and collection guidance",
      "Preparation of explanation documents",
      "Additional document response after filing",
    ],
    price: "From ¥55,000",
    priceAmount: 55000,
    priceNote: "Translation, multiple family members, or income explanation may require a separate quote.",
    faqs: [
      { q: "Can my spouse and child apply together?", a: "Yes. We review income, housing, and family documents for joint applications." },
      { q: "Can a dependent visa holder work?", a: "Work is not allowed in principle, but limited part-time work may be possible with permission." },
      { q: "Can students bring family members?", a: "In some cases, yes. Living expenses, housing, and support ability are important." },
    ],
  },
  "specified-skilled-worker": {
    ...
    lead: "Support for companies hiring foreign workers under the Specified Skilled Worker status.",
    description:
      "We review exams, employment conditions, support plans, and company-side documents for SSW applications.",
    metaTitle: "Specified Skilled Worker Visa Support | Gyoseishoshi Arch Office",
    metaDescription:
      "Support for Specified Skilled Worker visa applications in Japan. Hiring, support plans, required documents, refusal risks, and fees.",
    keywords: ["Specified Skilled Worker visa", "SSW visa Japan", "foreign hiring Japan", "tokutei ginou"],
    overview: [
      "The Specified Skilled Worker status allows foreign nationals to work in designated industries facing labor shortages.",
      "Immigration reviews the applicant's skills and Japanese ability, as well as employment terms and support structure.",
      "Applications may involve transition from technical intern training, change from student status, or overseas recruitment.",
    ],
    requirements: [
      "The job must fall within an eligible industry and work category",
      "The applicant must pass required skills and Japanese exams or qualify through technical intern training",
      "Employment terms and salary must be appropriate",
      "The employer must have a support system or contract with a registered support organization",
      "The employer must comply with tax, social insurance, and labor laws",
    ],
    documents: [
      "Application form, photo, passport, and residence card",
      "Employment contract, working conditions, and support plan",
      "Skills and Japanese exam certificates or technical intern training documents",
      "Company registration, financial documents, and compliance documents",
      "Registered support organization contract and industry-specific documents",
    ],
    refusalReasons: [
      "The job does not fall within an eligible SSW category",
      "Exam or training completion evidence is insufficient",
      "Employment terms or salary are inappropriate",
      "Support plan or acceptance system is insufficient",
      "Employer has tax, social insurance, or labor compliance issues",
    ],
    support: [
      "Eligibility review for industry and job duties",
      "Organization of applicant, company, and industry-specific documents",
      "Review and preparation of working conditions and support plan",
      "Additional document response after filing",
    ],
    price: "From ¥55,000",
    priceAmount: 55000,
    priceNote: "Fees vary by industry, number of applicants, support organization use, and company document readiness.",
    faqs: [
      { q: "Can technical interns change to SSW?", a: "In some cases, yes. We review the field, completion status, and required documents." },
      { q: "Do we need a registered support organization?", a: "If the employer cannot provide support internally, outsourcing to a registered support organization may be needed." },
      { q: "Can we apply for multiple workers?", a: "Yes. We organize the process according to industry, timing, and company documents." },
    ],
  },
};
